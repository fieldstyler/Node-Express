...
module FileHandler
  ...
  def self.translate_to_braille(english_file_name, braille_file_name)
    ...
    puts "Created #{braille_file_name} containing #{File.read(braille_file_name).chomp.length} characters."
  end
  ...
  def self.translate_to_english(braille_file_name, english_file_name)
    ...
    puts "Created #{english_file_name} containing #{File.read(english_file_name).chomp.length} characters."
  end
